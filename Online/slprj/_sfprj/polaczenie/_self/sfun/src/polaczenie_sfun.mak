...
MACHINE     = polaczenie
TARGET      = sfun
CHART_SRCS 	= c1_polaczenie.c
MACHINE_SRC	= polaczenie_sfun.c
MACHINE_REG = polaczenie_sfun_registry.c
MAKEFILE    = polaczenie_sfun.mak
...
OBJLIST_FILE = polaczenie_sfun.mol
