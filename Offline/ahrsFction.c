...
#define S_FUNCTION_NAME ahrsFction
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          5
/* Input Port  0 */
#define IN_PORT_0_NAME      accIn
...
#define SOURCEFILES "__SFB__AHRS/artykul.c__SFB__AHRS/MahonyAHRS.c"
#define PANELINDEX           6
...
{
    const real32_T   *accIn  = (const real32_T*) ssGetInputPortSignal(S,0);
    const real32_T   *gyroIn  = (const real32_T*) ssGetInputPortSignal(S,1);
    const real32_T   *magIn  = (const real32_T*) ssGetInputPortSignal(S,2);
    const real32_T   *Kp  = (const real32_T*) ssGetInputPortSignal(S,3);
    const real32_T   *Ki  = (const real32_T*) ssGetInputPortSignal(S,4);
    real32_T        *quat  = (real32_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    ahrsFction_Outputs_wrapper(accIn, gyroIn, magIn, Kp, Ki, quat, xD);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    ahrsFction_Update_wrapper(accIn, gyroIn, magIn, Kp, Ki, quat,  xD);
}
