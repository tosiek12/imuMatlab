...
#define S_FUNCTION_NAME computeAngles
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      accelerometerIn
...
/* Input Port  1 */
#define IN_PORT_1_NAME      magnetometerIn
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      XRollAngleOut
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      YPitchAngleOut
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      ZYawAngleOut
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      ZYawAngleFlatOut
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      TiltAngleOut
...
#define SOURCEFILES "__SFB__Matlab_Ccode/angles.c"
#define PANELINDEX           6
...
{
    const real32_T   *accelerometerIn  = (const real32_T*) ssGetInputPortSignal(S,0);
    const real32_T   *magnetometerIn  = (const real32_T*) ssGetInputPortSignal(S,1);
    real32_T        *XRollAngleOut  = (real32_T *)ssGetOutputPortRealSignal(S,0);
    real32_T        *YPitchAngleOut  = (real32_T *)ssGetOutputPortRealSignal(S,1);
    real32_T        *ZYawAngleOut  = (real32_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *ZYawAngleFlatOut  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real32_T        *TiltAngleOut  = (real32_T *)ssGetOutputPortRealSignal(S,4);

    computeAngles_Outputs_wrapper(accelerometerIn, magnetometerIn, XRollAngleOut, YPitchAngleOut, ZYawAngleOut, ZYawAngleFlatOut, TiltAngleOut);
}
