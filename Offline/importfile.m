function putty60sekobrotywdwochosiach = importfile(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   PUTTY60SEKOBROTYWDWOCHOSIACH = IMPORTFILE1(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   PUTTY60SEKOBROTYWDWOCHOSIACH = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   putty60sekobrotywdwochosiach = importfile1('putty60sek_obroty w dwoch
%   osiach.log', 3, 6002);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/11/22 13:11:17
...
putty60sekobrotywdwochosiach = [dataArray{1:end-1}];
